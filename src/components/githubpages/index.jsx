...
function GithubPages() {
  return (
    <>
      ...
      <p>
        ahora ingresamos al package.json y agregamos la siguiente regla:
      ...
      <h3>
        3. Crear reglas y prereglas en package.json en scripts:
      </h3>
      <p>
        recordar que la palabra PRE es una regla que hace que se
        ejecute primero esa regla antes de la regla con ese nombre
        <br />
        recordar que la palabra POST es una regla que hace que se
        ejecute despues de la regla con ese nombre
        <br />
        (Nota para mas informacion revisa el package.json de este proyecto)
      </p>
      <p>
        Primera regla a ejecutar(comando para compilar la app que
        a su vez llama la regla de "build": "react-scripts build")
      </p>
      ...
      <p>
        estando en el repositorio remoto github vamos a Settings-&gt;Pages
