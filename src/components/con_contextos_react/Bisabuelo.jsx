...
function Bisabuelo() {
  ...
  const {
    bisabuelo, abuelo, padre, hermana, hermano, setBisabuelo
      ...
      <ol>
        <li>
          ...
          <p>
            ...
            para un árbol de componentes en React, como el usuario autenticado actual,
        ...
        <li>
          <a href="https://www.youtube.com/watch?v=LV9qFupFxUQ&list=PLvq-jIkSeTUZ5XcUw8fJPTBKEHEKPMTKk&index=79">
            Video (jonmircha) (Curso React: 79. Context API -
